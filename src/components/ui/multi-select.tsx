...
interface MultiSelectProps
  ...
  /**
   * Placeholder string to display when no results are found.
   * Optional, defaults to null.
   */
  NoResultPlaceholder?: React.ReactNode;

  /**
   * Placeholder string to display for search input.
   * Optional, defaults to default string.
   */
  ...
  (
    ...
    return (
      ...
      >
        ...
        <PopoverContent
          className="flex min-w-full justify-center items-center p-0"
          align="start"
